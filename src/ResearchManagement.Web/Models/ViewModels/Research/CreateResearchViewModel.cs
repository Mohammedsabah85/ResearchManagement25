...
namespace ResearchManagement.Web.Models.ViewModels.Research
{
    public class CreateResearchViewModel
    {
        ...
        [StringLength(500, ErrorMessage = "عنوان البحث يجب ألا يتجاوز 500 حرف")]
        public string Title { get; set; } = string.Empty;

        [StringLength(500, ErrorMessage = "العنوان الإنجليزي يجب ألا يتجاوز 500 حرف")]
        public string? TitleEn { get; set; }

        [Required(ErrorMessage = "الملخص باللغة العربية مطلوب")]
        [StringLength(2000, MinimumLength = 50, ErrorMessage = "الملخص يجب أن يكون بين 50 و 2000 حرف")]
        public string AbstractAr { get; set; } = string.Empty;

        [StringLength(2000, ErrorMessage = "الملخص الإنجليزي يجب ألا يتجاوز 2000 حرف")]
        public string? AbstractEn { get; set; }

        [StringLength(500, ErrorMessage = "الكلمات المفتاحية يجب ألا تتجاوز 500 حرف")]
        public string? Keywords { get; set; }

        [StringLength(500, ErrorMessage = "الكلمات المفتاحية الإنجليزية يجب ألا تتجاوز 500 حرف")]
        ...
        [StringLength(500, ErrorMessage = "المنهجية يجب ألا تتجاوز 500 حرف")]
        public string? Methodology { get; set; }

        [StringLength(1000, ErrorMessage = "الملاحظات يجب ألا تتجاوز 1000 حرف")]
        public string? Notes { get; set; }

        // المؤلفون - إزالة ValidateComplexType لتجنب مشاكل Model Binding
        public List<CreateAuthorViewModel> Authors { get; set; } = new();
        ...
        // القوائم المنسدلة - تجاهلها في Model Binding
    ...
    public class CreateAuthorViewModel
    {
        ...
        [StringLength(100, ErrorMessage = "الاسم الأول الإنجليزي يجب ألا يتجاوز 100 حرف")]
        public string? FirstNameEn { get; set; }

        [StringLength(100, ErrorMessage = "اسم العائلة الإنجليزي يجب ألا يتجاوز 100 حرف")]
        public string? LastNameEn { get; set; }

        [Required(ErrorMessage = "البريد الإلكتروني مطلوب")]
        [EmailAddress(ErrorMessage = "البريد الإلكتروني غير صالح")]
        [StringLength(255, ErrorMessage = "البريد الإلكتروني يجب ألا يتجاوز 255 حرف")]
        public string Email { get; set; } = string.Empty;

        [StringLength(200, ErrorMessage = "اسم المؤسسة يجب ألا يتجاوز 200 حرف")]
        public string? Institution { get; set; }

        [StringLength(100, ErrorMessage = "الدرجة العلمية يجب ألا تتجاوز 100 حرف")]
        public string? AcademicDegree { get; set; }

        [RegularExpression(@"^\d{4}-\d{4}-\d{4}-\d{4}$", ErrorMessage = "رقم ORCID يجب أن يكون بالصيغة: 0000-0000-0000-0000")]
